...
val storageAccount = dbutils.secrets.get(scope="demo", key="storageaccount")
val containerName = "polybase"
val accessKey = dbutils.secrets.get(scope="demo", key="storagekey")
...
val jdbcURI = dbutils.secrets.get(scope="demo", key="jdbc")
